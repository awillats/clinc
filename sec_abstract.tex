...
A primary goal of neuroscience is identifying causal relationships between portions of the brain\todo{make this sound more neuro-legit},
%it's difficult.
a task that is challenging\todo{challenging $\to$ impossible?} when only interventional data is available despite increasing volumes of data.
